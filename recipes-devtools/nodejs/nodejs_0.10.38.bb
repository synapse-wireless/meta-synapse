# Use the receipe from meta-openembedded fido
# http://cgit.openembedded.org/meta-openembedded/plain/meta-oe/recipes-devtools/nodejs/nodejs_0.12.2.bb
# Had to drop support back to nodejs v0.10.x for ARMv5 support
