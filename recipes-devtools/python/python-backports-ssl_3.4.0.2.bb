# Grabbed from meta-openembedded fido
# When we switch to fido this should be dropped
# http://cgit.openembedded.org/meta-openembedded/plain/meta-python/recipes-devtools/python/python-backports-ssl_3.4.0.2.bb
