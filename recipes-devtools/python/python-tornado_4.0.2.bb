# This is taken from meta-openembedded fido
# When we switch to fido this should be dropped
# http://cgit.openembedded.org/meta-openembedded/tree/meta-python/recipes-devtools/python/python-tornado_4.0.2.bb
